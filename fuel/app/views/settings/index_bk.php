          ...
          <ul class="media-list media-list-users list-group">
              ...
              <div class="page_content" data-idx="1">
                ...
                <li class="list-group-item">
                  ...
                  タイトル：<input type="text" name="title1" value="<?php echo $title;?>" style="width: 100%;" class="form-control title" data-action="grow" data-name="title" checked="checked">
                </li>
                ...
                <?php if($type = "right_image_caption"):?>
                ...
                <?php endif;?>
                <?php if($type = "left_image_caption"):?>
