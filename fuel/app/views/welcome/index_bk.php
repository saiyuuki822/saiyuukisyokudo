          ...
          <div class="media-body">
            <div style="text-align: right;">
              ...
              <div class="media-heading">
                ...
                <a href="/<?php echo $data['name'];?>" target="_blank"><h5><?php echo $data["user_name"];?></h5></a>
              </div>
            <h3>
              <a href=""><?php echo $data["title"];?></a>
            </h3>
            <p>
              <?php echo strip_tags($data["body_value"]);?>
            </p>
            <div class="media-body-inline-grid" data-grid="images">
              <div style="display: none">
                <img data-action="zoom" data-width="1050" data-height="700" src="<?php echo $data["image"][0];?>">
              </div>
              <?php if(isset($data["image_caption"][0]["field_image"])): ?>
              <div style="display: none">
                <img data-action="zoom" data-width="640" data-height="640" src="<?php echo $image[$data["image_caption"][0]["field_image"]];?>">
              </div>
              <?php endif;?>

              <?php if(isset($data["image_caption"][1]["field_image"])): ?>
              <div style="display: none">
                <img data-action="zoom" data-width="640" data-height="640" src="<?php echo $image[$data["image_caption"][1]["field_image"]];?>">
              </div>
              <?php endif;?>
              <?php if(isset($data["image_caption"][2]["field_image"])): ?>
              <div style="display: none">
                <img data-action="zoom" data-width="1048" data-height="700" src="<?php echo $image[$data["image_caption"][2]["field_image"]];?>">
              </div>
              <?php endif;?>
            </div>
